...
$msg="sorry email already taken";
 ...
 { 
  $sql="INSERT  INTO users(id,uname,email,phone,uaddress,pass,cpass) VALUES(NULL,'$name','$email',  '$phone', '$address','$pass',  '$cpass')";
...
<body>
<div style="background-image: url('login.jpg');">
 <div class="container ">
    <div class="block">
        <div class="item">
            <h2>SIGNUP</h2><br>
              <form method='post'>
               ...
               <input type="text" name="phone" maxlength="10" minlength="10" placeholder="Enter phone.."required><br>
               </div>
